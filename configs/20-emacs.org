...
#+BEGIN_SRC elisp :noweb-ref emacs
  ...
  (use-package org-agenda
    :init
    (if (eq system-type 'windows-nt)
            (setq org-agenda-files (directory-files-recursively (concat (getenv "HOMEPATH") "/Notes/") "\\.org$"))
      (setq org-agenda-files (directory-files-recursively (concat (getenv "HOME") "/Notes/") "\\.org$"))))
