  ...
  (use-package elfeed
    ...
    (setq elfeed-feeds
      '(("https://xkcd.com/rss.xml" webcomic)
        ...
        ;; Chris Kohler News
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC9xafGPnAr0hxZ_bYMp1JsQ" youtube comedy economics)
        ;; Venjent
        ...
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCskD50ri3723Tk1SkS-qAIA" youtube music drums)
        ;; Legal Eagle
        ...
        ;; Telex
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCM-1sd-cXSuCsfWp8QMY_OQ" youtube hungary)
        ;; Games Done Quick
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCI3DTtB-a3fJPjKtQ5kYHfA" youtube gaming speedrunning)
        ;; James Hoffmann
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCMb0O2CdPBNi-QqPk5T3gsQ" youtube coffee)
        ;; Babymetal
        ...
        ;; 444
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCGoLa-QhHmTxLEdjv_8dxrg" youtube hungary news)
        ;; Abyssoft
        ...
        ;; Andrew Tropin
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCuj_loxODrOPxSsXDfJmpng" youtube opensource scheme)
        ;; Atomic Frontier
        ...
        ;; Benn Jordan
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCshObcm-nLhbu8MY50EZ5Ng" youtube music)
        ;; Blender
        ...
        ;; Brandon Y Lee
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC-WpvHaSBQEAztK6n_CupOg" youtube video photography)
        ;; Brodie Robertson
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCld68syR8Wi-GY_n4CaoJGA" youtube video linux opensource)
        ;; Bryan Johnson
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCnRVL1-HJnXWB_Xi2dAoTcg" youtube video health longevity)
        ;; Bödőcs Tibor
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UClUSqujSdARUgqlgX-FfAZA" youtube video comedy hungary)
        ;; Captain Disillusion
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCEOXxzW2vU0P-0THehuIIeg" youtube video comedy photography)
        ;; Chase and Status
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCGBpxWJr9FNOcFYA5GkKrMg" youtube video music dnb)
        ;; Chinese Man
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCa2OR2nl26Ht0Gg_IkCd7DQ" youtube video music)
        ;; Cinemassacre:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC0M0rxSz3IF0CsSour1iWmw" youtube video gaming)
        ;; Coffeezilla
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCFQMnBA3CS502aghlcr0_aw" youtube video scams)
        ;; Computerphile
        ...
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC3CBOpT2-NRvoc2ecFMDCsA" youtube video botany)
        ;; Dalfutár:
        ...
        ;; Electric Callboy
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCAR30oDTNbJE-Zd2NDg1mTQ" youtube video music metal)
        ;; ElectroBOOM
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCJ0-OtVpF0wOKEqT2Z1HEtA" youtube video electronics)
        ;; ESA Speedrunning
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC3Oe-jfrIqEGygxYBYyN6jQ" youtube video gaming speedrunning)
        ;; Explaining Computers:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCbiGcwDWZjz05njNPrJU7jA" youtube electronics)
        ;; Folding Ideas
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCyNtlmLB73-7gtlBz00XOQQ" youtube video essays)
        ;; Frog Leap Studios
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC98tcedR6gULv8_b70WJKyw" youtube video music metal)
        ;; Game Maker's Toolkit
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCqJ-Xo29CKyLTjn6z2XwYAw" youtube video gaming)
        ;; Games Nexus:
        ...
        ;; GDConf
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC0JB7TSe49lg56u6qH8y_MQ" youtube video gaming conference)
        ;; GDQuest:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCxboW7x0jZqFdvMdCFKTMsQ" youtube gamedev opensource)
        ;; Glucose Revolution
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCsQdi6X-12eUKBBBze46STA" youtube video eating health)
        ;; GMHikaru:
        ...
        ;; Guix Social
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UChW6oX-CYk5jWYZKZaMpVKg" youtube video opensource scheme guix guile)
        ;; GVMERS:
        ...
        ;; Jeff Geerling
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCR-DXc1voovS8nhAvccRZhg" youtube video opensource electronics)
        ;; Jimmy Broadbent
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCq-ylUNa9RoTK5jr6TBOYag" youtube video simracing)
        ;; Karl Jobst:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC3ltptWa0xfrDweghW94Acg" youtube speedrun)
        ;; Katinka Halápi
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCy0y9YEfErsC-IaLnZvUV-A" youtube video music drums)
        ;; Kovács András Péter:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCENUgjfqTMUmssyGCNObyEg" youtube hungary comedy)
        ;; Krazam
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCgBVkKoOAr3ajSdFFLp13_A" youtube video comedy programming)
        ;; Kurzgesagt:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCsXVk37bltHxD1rDPwtNM8Q" youtube science)
        ;; Kétfarkú Kutya Párt
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCBFovo0_BUOuI1mgWSvEfqA" youtube video politics)
        ;; Last Week Tonight:
        ...
        ;; Liam Carps
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCIOfoptCwOUiE-hnjrhl21Q" youtube video comedy germany)
        ...
        ;; Louis Rossmann
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCl2mFZoRqjw_ELax4Yisf6w" youtube video electronics)
        ;; Low Level
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC6biysICWOJ-C3P4Tyeggzg" youtube video security coding)
        ;; Low Spec Gamer
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCQkd05iAYed2-LOmhjzDG6g" youtube video gaming documentary)
        ;; Magyarország Kedvenc Műsora
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC8BRuUwMn6_ObKHR0XwqgcA" youtube video comedy hungary)
        ;; Mark Rober
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCY1kMZp36IQSyNx_9h4mpCg" youtube video engineering)
        ;; MattKC:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UChrYe70o7NmDioL02PRVWVg" youtube gamedev documentary)
        ;; Nathan Baggs
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCQvW_89l7f-hCMP1pzGm4xw" youtube video coding)
        ;; Nerdforge
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCggHsHce2n3vvbJf_8YKrMA" youtube video engineering crafting)
        ;; Network Chuck:
        ...
        ;; People Make Games
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCZB6V9fUov0Mx_us3MWWILg" youtube video gaming documentary)
        ;; Philosophy Tube
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC2PA-AKmVpU6NKCGtZq_rKQ" youtube video documentary)
        ;; Physics Girl:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC7DdEm33SyaTDtWYGO2CwdA" youtube physics science)
        ;; Pottyondy Edina
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC_fAjvoGnqySaNM6DRfFiCA" youtube video comedy)
        ;; Programmers are also human:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCi8C7TNs2ohrc6hnRQ5Sn2w" youtube comedy programming)
        ;; Protesilaos Stavrou
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC0uTPqBCFIpZxlz_Lv1tk_g" youtube video opensource emacs programming coding)
        ;; Rammstein Official:
        ...
        ;; Ren
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCqq3VcwPGseErHUa0-xLInQ" youtube video music)
        ;; Renaissance Periodization:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCfQgsKhHjSyRLOp9mnffqVg" youtube sports science)
        ;; Rob Scallon
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCyDZai57BfE_N0SaBkKQyXg" youtube video music)
        ;; Ryan C. Gordon:
        ...
        ;; Scott Manley
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCxzC4EngIsMrPmbm6Nxvb-A" youtube video space engineering) 
        ;; Serve The Home
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCv6J_jJa8GJqFwQNgNrMuww" youtube video homelab)
        ;; Simone Giertz:
        ...
        ;; Spacejunkie Zoom
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCrHuPkaYT35D1u-z33SDKug" youtube video space)
        ;; Spacejunkie Űrutazás:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCCbfGK0rnXmjUGS1KgbKepA" youtube science space)
        ;; Stand-up Maths
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCSju5G2aFaWMqn-_0YBtq5A" youtube video comedy maths)
        ;; Starpower Drummer:
        ...
        ;; Ten Second Songs
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCm6r_b2K5jn1JGkwDcwJXrQ" youtube video music)
        ;; The Back Focus
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UC7sg9FpMWMamzWE2lJPY-Dg" youtube video film movies)
        ;; The Charismatic Voice:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCK5G-rUDSKKUXeMkrL7Bs1w" youtube music singing)
        ;; The Spiffing Brit:
        ...
        ;; The Primeagen:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCUyeluBRhGPCW4rPe_UvBZQ" youtube programming)
        ;; Thoughtbot
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCUR1pFG_3XoZn3JNKjulqZg" youtube video programming coding)
        ;; Till Lindemann:
        ...
        ;; TronicsFix
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCfOrKQtC1tDfGf_fFVb8pYw" youtube video electronics repairing)
        ;; Tóth Jakab
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCOVPox-i8NlRaoRb7HsjOpw" youtube video politics hungary)
        ;; Veritasium:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCHnyfMqiRRG1u-2MsSQLbXA" youtube science documentary)
        ;; Voidzilla:
        ...
        ;; Szekszárder:
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCQHCImKcC9HtXm5Sbl-uQwg" youtube video hungary documentary)
