...
#+BEGIN_SRC bat :noweb-ref emacs-daemon-windows
  ...
  if exist "C:\Program Files\Emacs\emacs-29.4\bin\runemacs.exe" (
    START /B "" "C:\Program Files\Emacs\emacs-29.4\bin\runemacs.exe" --daemon --init-directory %USERPROFILE%"/.config/emacs"
  )
#+END_SRC
