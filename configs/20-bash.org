...
#+begin_src bash :noweb-ref profile
  ...
  # Put the inputrc config file to an XDG compliant dir
  export INPUTRC="$XDG_CONFIG_HOME"/readline/inputrc

  # Put the gnupg folder to an XDG compliant dir
  ...
  # PATH settings
  export PATH="$HOME/.local/bin:$HOME/.composer/vendor/bin:$HOME/gems/bin:$HOME/lutris/bin:${KREW_ROOT:-$HOME/.krew}/bin:$PATH"
