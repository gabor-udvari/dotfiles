...
#+BEGIN_SRC elisp :noweb-ref emacs
  (use-package flyspell
    ...
    (let ((hunspell-dir (concat (if (eq system-type 'windows-nt) (getenv "USERPROFILE") "~") (if (executable-find "guix") "/.guix-home/profile" "/.local") "/share/hunspell/")))
      (setq ispell-hunspell-dict-paths-alist
            `(("hu_HU" ,(expand-file-name (concat hunspell-dir "hu_HU.aff")))
              ("en_US" ,(expand-file-name (concat hunspell-dir "en_US.aff")))
              )))
